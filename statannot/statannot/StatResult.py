class StatResult:
#     def __init__(self, test_str, test_short_name, stat_str, stat, pval, eff_size):
...
#             stat_summary = '{}, P_val={:.3e} {}={:.3e} Eff_size={:.3e}'.format(
#                 self.test_str, self.pval, self.stat_str, self.stat, self.eff_size
#             )
        return stat_summary
